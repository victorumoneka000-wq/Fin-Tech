...
export default function App() {
  ...
  return (
    <div id="financial-workspace" className="flex h-screen w-screen overflow-hidden bg-[#F8FAFC] text-slate-900 font-sans pb-16 md:pb-0">
      
      {/* 3. Sidebar Navigation Container (Desktop) */}
      <nav id="left-nav" className="hidden md:flex w-[72px] bg-[#0F172A] flex-col items-center py-6 gap-8 border-r border-slate-200 shrink-0">
      ...
      <div className="flex-1 flex overflow-hidden">
          ...
          <header className="h-16 flex items-center justify-between px-8 bg-white border-b border-slate-200 shrink-0">
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                className={`hidden md:flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-bold transition-all border shrink-0 cursor-pointer ${
                  showChat 
        ...
        {/* Permanent Right AI Chatbot Pane with sliding drawer behaviour on mobile + resizability */}
        {showChat && (
          <>
            {/* Voile de fond gris sur mobile */}
            <div 
            ...
            >
              ...
              {/* Le Poignée de redimensionnement (Drag handle) */}
              <div 
              ...
              <div className="p-4 border-t border-slate-200 bg-white shrink-0 pl-8 md:pl-4">
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-1.5 top-1.5 w-9 h-9 bg-indigo-600 hover:bg-indigo-750 text-white rounded-lg flex items-center justify-center disabled:opacity-30 disabled:hover:bg-indigo-600 shadow-md shadow-indigo-100 transition-all cursor-pointer"
